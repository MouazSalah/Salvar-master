...
public class ItemsAdapter extends ListAdapter<NoteEntity, ItemsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(View view)
        {
            ...
            view.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    listener.onClick(getNote(getLayoutPosition()).getId(),getNote(getLayoutPosition()).getNoteCost() ,getLayoutPosition());
                }
            });
    ...
    {
        void onClick(int noteId, double noteCost, int position);
